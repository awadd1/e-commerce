        ...
        ->addColumn('action', function($query){
            ...
            $moreBtn ='<div class="btn-group dropstart" style="margin-left:3px">
                ...
                <ul class="dropdown-menu">   
                    <li> <a class="dropdown-item has-icon" href="'.route('vendor.products-image-gallery.index',['product' => $query->id]).'">Image Gallery</a></a></li>
            ...
            ->addColumn('status', function($query){
                if($query->status == 1){
                    ...
                    <input checked class="form-check-input change-status" type="checkbox" role="switch" id="flexSwitchCheckDefault" data-id="'.$query->id.'"></div>';
                }else {
                    $button ='<div class="form-check form-switch">
                    <input class="form-check-input change-status" type="checkbox" role="switch" id="flexSwitchCheckDefault" data-id="'.$query->id.'"></div>';
                }
                return $button;
            })
