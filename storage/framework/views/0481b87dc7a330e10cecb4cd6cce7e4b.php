            ...
            <div class="col-xl-12">
                <div class="relative_contect d-flex">
                    ...
                    <ul class="wsus_menu_cat_item show_home toggle_menu">
                        ...
                        <li><a class="<?php echo e(count($category->subCategories) > 0 ? 'wsus__droap_arrow' : ''); ?>" href="#"><i class="<?php echo e($category->icon); ?>"></i> <?php echo e($category->name); ?> </a>
                            <?php if(count($category->subCategories) > 0): ?>
                                <ul class="wsus_menu_cat_droapdown">
                                    <?php $__currentLoopData = $category->subCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li><a href="#"><?php echo e($subCategory->name); ?> <i class="<?php echo e(count($subCategory->childCategories) > 0 ? 'fas fa-angle-right' : ''); ?>"></i></a>
            ...
            <div class="wsus__mobile_menu_main_menu">
                <div class="accordion accordion-flush" id="accordionFlushExample">
                    <ul class="wsus_mobile_menu_category">
                       ...
                       <li>
                        <a href="#" class=" <?php echo e(count($categoryItem->subCategories) > 0 ? 'accordion-button' : ''); ?> collapsed" data-bs-toggle="collapse"
                               data-bs-target="#flush-collapseThreew-<?php echo e($loop->index); ?>" aria-expanded="false"
                               aria-controls="flush-collapseThreew-<?php echo e($loop->index); ?>"><i class="<?php echo e($categoryItem->icon); ?>"></i> <?php echo e($categoryItem->name); ?> </a>
                            <?php if(count($categoryItem->subCategories) > 0): ?>
                                <div id="flush-collapseThreew-<?php echo e($loop->index); ?>" class="accordion-collapse collapse"
                                    data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body">
                                        <ul>
                                            <?php $__currentLoopData = $categoryItem->subCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subCategoryItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                              
                                            <li><a href="#"> <?php echo e($subCategoryItem->name); ?> </a></li>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<!--============================
    MOBILE MENU END
==============================-->
<?php /**PATH C:\Awadd\project\e-commerce\resources\views/frontend/layouts/menu.blade.php ENDPATH**/ ?>