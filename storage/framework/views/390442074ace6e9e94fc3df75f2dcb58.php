                      ...
                      <div class="col-md-4">
                        <div class="form-group ">
                          ...
                          <select id="inputState" class="form-control sub-category" name="discount_type">
                            ...
                            <option value="amount">Amount (<?php echo e($settings->currency_icon); ?>)</option>
                          </select>
                        </div>
                      </div>
                      <div class="col-md-8">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Awadd\project\e-commerce\resources\views/admin/coupon/create.blade.php ENDPATH**/ ?>