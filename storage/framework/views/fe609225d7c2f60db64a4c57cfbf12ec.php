<div class="dashboard_sidebar">
  ...
  <ul class="dashboard_link">
    ...
    <li><a href="<?php echo e(route('user.address.index')); ?>"><i class="fal fa-gift-card"></i> Addresses</a></li>
    <li>
...
</div><?php /**PATH C:\Awadd\project\e-commerce\resources\views/frontend/dashboard/layouts/sidebar.blade.php ENDPATH**/ ?>